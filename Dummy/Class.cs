namespace Dummy
{
    ...
    public sealed class Class
    {
        ...
        /// <summary>Converts the <paramref name="integer"/> to a <see cref="double"/> instance.</summary>
        /// <param name="integer">An <see cref="int"/> instance.</param>
        /// <returns>A <see cref="Class"/> instance.</returns>
        public static explicit operator Class(int integer) => null;
